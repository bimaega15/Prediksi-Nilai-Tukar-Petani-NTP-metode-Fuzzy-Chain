...
<head>
    ...
    <meta name="description" content="Penerapan Metode Fuzzy Chen menggunakan Particle Swarm Optimization">
    ...
    <link rel="stylesheet" href="<?= base_url('public/library/bootstrap-datepicker-master/dist/css/bootstrap-datepicker.min.css') ?>">
...
<body id="page-top">
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">Pilih Logout untuk anda ingin keluar</div>
    ...
    <script src="<?= base_url('public/library/bootstrap-datepicker-master/dist/js/bootstrap-datepicker.min.js') ?>"></script>
